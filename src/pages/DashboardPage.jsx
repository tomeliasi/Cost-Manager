...
export default function DashboardPage() {
  ...
  const badges = useMemo(() => {
    ...
    if (ratesError)
      list.push({ label: "Rates fetch failed", color: "warning" });
    return list;
          ...
          <Paper sx={{ p: 3 }}>
            <Stack spacing={1}>
              ...
              <Typography color="text.secondary">
                Add a new cost item. The date is set automatically to the day
                you add it.
              </Typography>
              <Button
        ...
        <Grid item xs={12} md={5}>
          <Paper sx={{ p: 3 }}>
            <Stack spacing={1}>
              ...
              <Typography color="text.secondary">
                • Monthly report (month/year + currency)
              </Typography>
              <Typography color="text.secondary">
                • Pie chart by category
              </Typography>
              <Typography color="text.secondary">
                • Bar chart (12 months) by year
              </Typography>
              <Typography color="text.secondary">
                • Settings: exchange rates URL
              </Typography>
            </Stack>
          </Paper>
        </Grid>
